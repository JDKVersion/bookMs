...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/rentBook.js"></script>
<style>
<!--
.pageshow {
					...
					<tbody>
						<c:forEach items="${requestScope.pageMsg.lists}" var="book">
							<tr>
								...
								<td>${book.price}</td>
								<td><input type="button" onclick="data(${book.id})" value="借书" style="height: 25px;width: 64px;background-color: #0000FF"></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
